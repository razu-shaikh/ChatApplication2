...
public class RequestsFragment extends Fragment {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        friendsRequestReferance = FirebaseDatabase.getInstance().getReference().child("Friend_Requests").child(online_user_id);
                            ...
                            if (request_type.equals("received"))
                            {
                                UsersReference.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot)
                                    {
                                        ...
                                        final String userImage = dataSnapshot.child("user_thumb_image").getValue().toString();
                                        final String userStatus = dataSnapshot.child("user_status").getValue().toString();

                                        viewHolder.setUserName(userName);
                                        viewHolder.setThumb_user_image(userImage,getContext());
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void setThumb_user_image(final String userImage, final Context ctx)
        {
